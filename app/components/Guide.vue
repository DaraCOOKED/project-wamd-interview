<template>
  <section id="guide" class="interview-process">
    <div class="ip-container">
      ...
      <h2 class="ip-heading">Three interviews stand between<br />you and another student who chose WMAD</h2>
      ...
      <ol class="ip-timeline">
        ...
        >
          <div class="ip-marker">
            <div class="ip-circle" v-html="step.icon" />
            <span v-if="index < steps.length - 1" class="ip-connector" :class="`ip-connector--${index}`" />
          </div>
...
const steps = [
  {
    ...
    description:
    "Question about some basic code like html css....",
  ...
  },
  {
    ...
    description:
      "Why did you choose this skill? Expect questions about your goals..",
  ...
  },
  {
    ...
    description:
      'A short group exercise with other students. This stage looks at how you communicate, listen, and contribute when working toward a shared goal.',
...
.ip-connector--0 {
  background: linear-gradient(to bottom, var(--ip-blue) 0%, var(--ip-blue) 45%, var(--ip-orange) 100%);
}

.ip-connector--1 {
  background: linear-gradient(to bottom, var(--ip-line-light) 0%, var(--ip-line-light) 60%, transparent 100%);
}
